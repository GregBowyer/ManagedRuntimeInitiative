...
#ifndef GPGC_GCMANAGERNEW_HPP
#define GPGC_GCMANAGERNEW_HPP
...
class GPGC_GCManagerNew: public GPGC_GCManagerMark
{
  private:
  ...
  protected:
    GPGC_GCManagerNew(long manager_number, HeapRefBufferList** free_list, HeapRefBufferList** full_list)
