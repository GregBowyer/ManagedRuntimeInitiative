...
#ifndef GPGC_GCMANAGERNEWFINAL_INLINE_HPP
#define GPGC_GCMANAGERNEWFINAL_INLINE_HPP
...
inline void GPGC_GCManagerNewFinal::mark_and_follow(objectRef* p, int referrer_kid)
{
  GPGC_NewCollector::mark_and_follow(this, p);
}


inline void GPGC_GCManagerNewFinal::mark_through(objectRef ref, int referrer_kid)
{
oop obj=ref.as_oop();
  ...
  assert0(GPGC_Marks::is_new_marked_final_live(ref));

  if ( GPGC_Marks::is_new_marked_strong_live(obj) ) {
...
#endif // GPGC_GCMANAGERNEWFINAL_INLINE_HPP
