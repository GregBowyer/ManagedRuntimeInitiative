...
void GPGC_NewCollector::reset_concurrency()
{
...
guarantee(!GPGCSafepointRelocate,"Can't set both GPGCSafepointMark and GPGCSafepointAll");
...
long GPGC_NewCollector::millis_since_last_gc()
{
...
void GPGC_NewCollector::reset_millis_since_last_gc()
{
