...
int main(int argc, char *argv[])
{
  ...
  if( !AD._no_output ) {
    fprintf(AD._HPP_file._fp,"#ifndef AD_PD_HPP\n");
    fprintf(AD._HPP_file._fp,"#define AD_PD_HPP\n");
    fprintf(AD._VM_file ._fp,"#ifndef ADGLOBALS_PD_HPP\n");
    fprintf(AD._VM_file ._fp,"#define ADGLOBALS_PD_HPP\n");
  }
  ...
  if( !AD._no_output ) {
    fprintf(AD._HPP_file._fp,"#endif // AD_PD_HPP\n");
    fprintf(AD._VM_file ._fp,"#endif // ADGLOBALS_PD_HPP\n");
  }
