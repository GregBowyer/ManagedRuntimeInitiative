...
"// statements (a series of if statements).\n"
  ...
  fprintf(fp, "  \n");
  fprintf(fp, "  default:\n");
fprintf(fp,"    C2OUT->print(\"Default case invoked for: \\n\");\n");
fprintf(fp,"    C2OUT->print(\"   opcode  = %cd, \\\"%cs\\\"\\n\", opcode, NodeClassNames[opcode]);\n",'%','%');
...
static void dumpekey(const void*key){fprintf(stdout,"%s",(const char*)key);}
...
// Print out the dictionary contents as key-value pairs
static void print_key(const void*key){fprintf(stdout,"%s",(const char*)key);}
