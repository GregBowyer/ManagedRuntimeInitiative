...
_bin=(bucket*)_arena->Amalloc_8(sizeof(bucket)*_size);
...
nb->_keyvals=(const void**)_arena->Amalloc_8(sizeof(void*)*nb->_max*2);
    int nbcnt = 0;
...
_bin[i]._keyvals=(const void**)_arena->Amalloc_8(sizeof(void*)*_bin[i]._max*2);
...
b->_keyvals=(const void**)_arena->Amalloc_8(sizeof(void*)*b->_max*2);
    } else {
