...
if(strcmp(opType,"CompareAndSwapP")==0)return Form::idealP;
if(strcmp(opType,"CompareAndSwapL")==0)return Form::idealL;
if(strcmp(opType,"CompareAndSwapI")==0)return Form::idealI;
