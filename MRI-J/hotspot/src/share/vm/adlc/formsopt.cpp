...
void RegisterForm::addRegDef(char*name,char*callingConv,
char*idealtype,char*encoding){
RegDef*regDef=new RegDef(name,callingConv,idealtype,encoding);
  _rdefs.addName(name);
...
//------------------------------RegDef-----------------------------------------
// Constructor
RegDef::RegDef(char*regname,char*callconv,char*idealtype,char*encode)
:_regname(regname),_callconv(callconv),
