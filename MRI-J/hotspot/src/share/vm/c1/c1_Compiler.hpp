...
#ifndef C1_COMPILER_HPP
#define C1_COMPILER_HPP
...
virtual const char*name()const{return"C1";}
...
virtual void compile_method(ciEnv*env,ciMethod*target,int entry_bci,bool retry_compile);

  // Print compilation timers and statistics
  virtual void print_timers();
};

#endif // C1_COMPILER_HPP
