...
#ifndef C1_GRAPHBUILDER_HPP
#define C1_GRAPHBUILDER_HPP
...
void connect_instrumentation_to_end(BlockBegin*beg);
...
void fill_sync_handler(Value lock,BlockBegin*sync_handler,bool default_handler,int old_cpdata_offset);
  ...
  void pop_scope(int old_cpdata_offset);
