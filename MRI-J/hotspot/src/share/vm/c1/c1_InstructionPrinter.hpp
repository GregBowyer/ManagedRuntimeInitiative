...
#ifndef C1_INSTRUCTIONPRINTER_HPP
#define C1_INSTRUCTIONPRINTER_HPP
...
class InstructionPrinter: public InstructionVisitor {
 ...
 public:
InstructionPrinter(bool print_phis=true,outputStream*output=C1OUT)
...
#endif // C1_INSTRUCTIONPRINTER_HPP
