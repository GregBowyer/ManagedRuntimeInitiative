...
#ifndef C1_VALUETYPE_HPP
#define C1_VALUETYPE_HPP
...
virtual ValueType*base()const{return ThreadLocals->_voidType;}
...
virtual ValueType*base()const{return ThreadLocals->_intType;}
...
virtual ValueType*base()const{return ThreadLocals->_longType;}
...
virtual ValueType*base()const{return ThreadLocals->_floatType;}
...
virtual ValueType*base()const{return ThreadLocals->_doubleType;}
...
virtual ValueType*base()const{return ThreadLocals->_objectType;}
...
virtual ValueType*base()const{return ThreadLocals->_addressType;}
...
virtual ValueType*base()const{return ThreadLocals->_illegalType;}
