...
// indexing between classes and codeBlobs to make dependency
...
class Dependencies: public ResourceObj {
 public:
  ...
  enum DepType {
    ...
    // method were used.  If it evolves (is replaced), the codeBlob
 ...
 public:
  ...
  // Create the encoding which will be stored in an codeBlob.
