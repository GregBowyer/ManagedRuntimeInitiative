...
enum OracleCommand {
  ...
  InlineCommand,
  DontInlineCommand,
  DontInlineCalleesCommand,
  BreakC1AfterCodeGenCommand,
  BreakC2AfterCodeGenCommand,
  DisableLoopOptsCommand,
  PrintIRCommand,
  CompileOnlyCommand,
  LogCommand,
  OptionCommand,
...
bool CompilerOracle::should_disable_inlining(methodHandle method){
return(check_predicate(DontInlineCalleesCommand,method));
}


bool CompilerOracle::should_break_c1_after_codegen(methodHandle method){
return(check_predicate(BreakC1AfterCodeGenCommand,method));
}


bool CompilerOracle::should_break_c2_after_codegen(methodHandle method){
return(check_predicate(BreakC2AfterCodeGenCommand,method));
}


bool CompilerOracle::should_disable_loopopts(methodHandle method){
return(check_predicate(DisableLoopOptsCommand,method));
}


bool CompilerOracle::should_print_ir(methodHandle method){
return(check_predicate(PrintIRCommand,method));
}
...
fileStream stream(cc_file(),true);
  stream.print("# ");
