...
void ObjectStartArray::initialize(MemRegion reserved_region, char* reserved_space_start) {
...
ReservedSpace backing_store(bytes_to_reserve,reserved_space_start,0);
