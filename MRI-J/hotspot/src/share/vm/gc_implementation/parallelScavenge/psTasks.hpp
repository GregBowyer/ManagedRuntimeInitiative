...
system_dictionary=4,
jvmti=5,
    arta_objects          = 6, // Only strong roots during scavenge!
    management            = 7
  }; 
 private:
  RootType _root_type;
 public:
  ...
  const char* name() { return (char *)"scavenge-roots-task"; }
...
class ThreadRootsTask : public GCTask {
 ...
 public:
  ...
  const char* name() { return (char *)"thread-roots-task"; }
...
class StealTask : public GCTask {
 ...
 public:
const char*name(){return(char*)"steal-task";}
...
class OldToYoungRootsTask : public GCTask {
 ...
 public:
  ...
  const char* name() { return (char *)"old-to-young-roots-task"; }
