...
#ifndef PSVIRTUALSPACE_HPP
#define PSVIRTUALSPACE_HPP
...
PSVirtualSpace(ReservedSpace rs,size_t alignment,
                 os::MemoryAccount account = os::CHEAP_COMMITTED_MEMORY_ACCOUNT);
...
bool initialize(ReservedSpace rs,size_t commit_size,
  ...
  inline  void   set_account(os::MemoryAccount account);
...
inline  void PSVirtualSpace::set_account(os::MemoryAccount account) {
  _account = account;
}
#endif // PSVIRTUALSPACE_HPP
