...
#ifndef PSYOUNGGEN_HPP
#define PSYOUNGGEN_HPP
...
class PSYoungGen : public CHeapObj {
 ...
 public:
  ...
  virtual void initialize_virtual_space(ReservedSpace rs, size_t alignment, os::MemoryAccount account = os::JAVA_COMMITTED_MEMORY_ACCOUNT);
  ...
  MemRegion committed_region() const { return MemRegion((HeapWord*)virtual_space()->low(), (HeapWord*)virtual_space()->high()); }
