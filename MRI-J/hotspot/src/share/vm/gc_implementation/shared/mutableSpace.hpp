...
#ifndef MUTABLESPACE_HPP
#define MUTABLESPACE_HPP

#include "copy.hpp"
#include "immutableSpace.hpp"
...
class MutableSpace: public ImmutableSpace {
 ...
 public:
  ...
  // Initialization
  virtual void initialize(HeapWord* start, HeapWord* end, bool clear_space);
...
debug_only(Copy::fill_to_words(mr.start(),mr.word_size(),(juint)badHeapWord));
  }
  ...
  void object_iterate_debug(ObjectClosure* cl); // a little more robust for iterating broken heaps
