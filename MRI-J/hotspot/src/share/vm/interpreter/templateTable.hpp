...
#ifndef TEMPLATETABLE_HPP
#define TEMPLATETABLE_HPP
...
class TemplateTable: AllStatic {
 ...
 private:
  ...
  static void locals_index(Register reg, int offset);
  static void iload();
...
static void _freturn(TosState state);
  static void areturn();
  ...
  static void _new    () { new_impl(UseSBA); }
  static void new_heap() { new_impl(false ); }
  static void new_impl( bool allow_sba );
  static void newarray     () { newarray_impl(UseSBA); }
  static void newarray_heap() { newarray_impl(false ); }
  static void newarray_impl( bool allow_sba );
  static void anewarray     () { anewarray_impl(UseSBA); }
  static void anewarray_heap() { anewarray_impl(false ); }
  static void anewarray_impl( bool allow_sba );
 ...
 public:
  ...
  // Platform specifics
#include "templateTable_pd.hpp"
};

#endif // TEMPLATETABLE_HPP
