...
#ifndef CARDTABLERS_HPP
#define CARDTABLERS_HPP
...
public:
  ...
  void inline_write_ref_field_gc(objectRef* field, oop new_val) {
    jbyte* byte = _ct_bs.byte_for(field);
    *byte = youngergen_card;
  }
  void write_ref_field_gc_work(objectRef* field, oop new_val) {
  ...
  virtual void write_ref_field_gc_par(objectRef* field, oop new_val);
