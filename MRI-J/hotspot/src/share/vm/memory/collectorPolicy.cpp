...
void GenCollectorPolicy::initialize_flags() {
  ...
  // Azul note: This check seems wrong to me - the new gen needs to be aligned as a whole,
  // but the 3 spaces within it have only minimal alignment restrictions. aB.
...
_min_gen0_size=MIN2(MAX2(_min_gen0_size,(size_t)NewSize),(size_t)MaxNewSize);
  ...
  size_t max_new_size = align_size_down(_max_heap_byte_size / (NewRatio+1),
					min_alignment());
max_new_size=MIN2(MAX2(max_new_size,(size_t)_min_gen0_size),(size_t)MaxNewSize);
