...
#ifndef DEFNEWGENERATION_HPP
#define DEFNEWGENERATION_HPP
...
void preserve_mark_if_necessary(oop obj,markWord*m);
...
GrowableArray<markWord*>*_preserved_marks_of_objs;
...
#undef DefNew_SINCE_SAVE_MARKS_DECL
  ...
  oop copy_to_survivor_space(oop old, objectRef* from);
