...
#ifndef GENOOPCLOSURES_HPP
#define GENOOPCLOSURES_HPP
...
inline void do_barrier(objectRef*p);
...
inline void do_oop(objectRef*p);
inline void do_oop_nv(objectRef*p);
