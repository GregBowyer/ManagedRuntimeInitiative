...
#ifndef GENREMSET_HPP
#define GENREMSET_HPP
...
protected:
  virtual void write_ref_field_gc_work(objectRef* field, oop new_val) = 0;
public:

  // A version of the above suitable for use by parallel collectors.
  virtual void write_ref_field_gc_par(objectRef* field, oop new_val) = 0;
