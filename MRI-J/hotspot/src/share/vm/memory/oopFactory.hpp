...
#ifndef OOPFACTORY_HPP
#define OOPFACTORY_HPP
...
static typeArrayOop new_boolArray(int length,intptr_t sba_hint,TRAPS){return typeArrayKlass::cast(Universe::boolArrayKlassObj())->allocate(length,sba_hint,CHECK_NULL);}
static typeArrayOop new_charArray(int length,intptr_t sba_hint,TRAPS){return typeArrayKlass::cast(Universe::charArrayKlassObj())->allocate(length,sba_hint,CHECK_NULL);}
static typeArrayOop new_singleArray(int length,intptr_t sba_hint,TRAPS){return typeArrayKlass::cast(Universe::singleArrayKlassObj())->allocate(length,sba_hint,CHECK_NULL);}
static typeArrayOop new_doubleArray(int length,intptr_t sba_hint,TRAPS){return typeArrayKlass::cast(Universe::doubleArrayKlassObj())->allocate(length,sba_hint,CHECK_NULL);}
static typeArrayOop new_byteArray(int length,intptr_t sba_hint,TRAPS){return typeArrayKlass::cast(Universe::byteArrayKlassObj())->allocate(length,sba_hint,CHECK_NULL);}
static typeArrayOop new_shortArray(int length,intptr_t sba_hint,TRAPS){return typeArrayKlass::cast(Universe::shortArrayKlassObj())->allocate(length,sba_hint,CHECK_NULL);}
static typeArrayOop new_intArray(int length,intptr_t sba_hint,TRAPS){return typeArrayKlass::cast(Universe::intArrayKlassObj())->allocate(length,sba_hint,CHECK_NULL);}
static typeArrayOop new_longArray(int length,intptr_t sba_hint,TRAPS){return typeArrayKlass::cast(Universe::longArrayKlassObj())->allocate(length,sba_hint,CHECK_NULL);}

  // create java.lang.Object[]
static objArrayOop new_objectArray(int length,intptr_t sba_hint,TRAPS){
    return objArrayKlass::
cast(Universe::objectArrayKlassObj())->allocate(length,sba_hint,CHECK_NULL);
  }

  static typeArrayOop    new_charArray           (const char* utf8_str, intptr_t sba_hint, TRAPS);
  ...
  static typeArrayOop    new_typeArray(BasicType type, int length, intptr_t sba_hint, TRAPS);
...
public:
  ...
  static methodCodeOop   new_methodCode(const CodeBlob *blob, const DebugMap *dbginfo, const PC2PCMap *pc2pcinfo, const CodeProfile *profile, objArrayHandle dep_klasses, objArrayHandle dep_methods, int compile_id, int entry_bci, bool has_unsafe, objArrayHandle srefs, TRAPS);

  // System object arrays
  static objArrayOop     new_system_objArray(int length, TRAPS);

  // Regular object arrays
static objArrayOop new_objArray(klassOop klass,int length,intptr_t sba_hint,TRAPS);
};

#endif // OOPFACTORY_HPP
