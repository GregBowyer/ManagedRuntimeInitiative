...
class Space: public CHeapObj {
 ...
 public:
  // I tried to yank this, thinking it was a holdover from the old Train
  // algorithm, long since removed.  However it appears to be used to some
  // kind of alignment requirement and is woven through the GC code.  I hope
  // someday a GC expert will come through and yank this.  CNC 10/6/2004
  static size_t car_size()         { return 1<<16/*LogOfCarSpaceSize*/; }
...
public:
  static bool insert_deadspace(size_t& allowed_deadspace_words, HeapWord* q, size_t word_len);
};
