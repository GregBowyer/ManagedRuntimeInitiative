...
#ifndef INSTANCEREFKLASS_HPP
#define INSTANCEREFKLASS_HPP
...
#define InstanceRefKlass_OOP_OOP_ITERATE_DECL(OopClosureType, nv_suffix)                \
  ...
  static void release_and_notify_pending_list_lock();
  static void acquire_pending_list_lock();
