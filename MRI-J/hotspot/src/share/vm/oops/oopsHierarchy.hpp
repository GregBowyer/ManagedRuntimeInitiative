...
#ifndef OOPSHIERARCHY_HPP
#define OOPSHIERARCHY_HPP
...
typedef class     methodCodeOopDesc*	    methodCodeOop;
typedef class   dependencyOopDesc*	    dependencyOop;
...
public:
  ...
  operator markWord() const           { return markWord(obj()); }
