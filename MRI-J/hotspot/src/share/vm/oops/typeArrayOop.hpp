...
#ifndef TYPEARRAYOOP_HPP
#define TYPEARRAYOOP_HPP
...
class typeArrayOopDesc : public arrayOopDesc {
 ...
 public:
  ...
  int object_size() { return GC_object_size(typeArrayKlass::cast(klass()));  }
  int GC_object_size(const typeArrayKlass* const tk) {
    return object_size(tk->layout_helper(), length());
  }
};
#endif // TYPEARRAYOOP_HPP
