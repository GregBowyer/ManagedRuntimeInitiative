...
#define PROB_COUNT_THRESHOLD    30
...
int is_range_check(Node*&range,Node*&index,jint&offset,PhaseGVN*phase);
...
no_handler_bci=InvocationEntryBci//the bci for fall through or catch-all projs
  };
