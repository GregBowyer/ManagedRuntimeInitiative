...
private:
uint _eff_degree;//Effective degree: Sum of neighbors
public:
...
public:
  ...
  uint8 _fat_proj_kill_regs; // kill count for fat_proj
...
public:
  ...
  // How many color choices can it make ?
  int degrees_of_freedom() const { return mask_size() - 1; }
...
_at_risk:1,//Simplify says this guy is at risk to spill
         _rematerialize:1;      // True if should rematerialize def
