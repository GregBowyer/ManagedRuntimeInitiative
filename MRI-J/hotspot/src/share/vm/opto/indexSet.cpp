...
if(reg_degree>=fail_degree)return 999999;
      } else {
...
C2OUT->print_cr("Accumulated IndexSet usage statistics:");
C2OUT->print_cr("--------------------------------------");
C2OUT->print_cr("  Iteration:");
C2OUT->print_cr("    blocks visited: %ld",total_blocks);
C2OUT->print_cr("    blocks empty: %4.2f%%",100.0*_total_unused_blocks/total_blocks);
C2OUT->print_cr("    bit density (bits/used blocks): %4.2f%%",(double)_total_bits/_total_used_blocks);
C2OUT->print_cr("    bit density (bits/all blocks): %4.2f%%",(double)_total_bits/total_blocks);
C2OUT->print_cr("  Allocation:");
C2OUT->print_cr("    blocks allocated: %d",_alloc_new);
C2OUT->print_cr("    blocks used/reused: %d",_alloc_total);
}
