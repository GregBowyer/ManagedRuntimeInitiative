...
#ifndef JVMTICODEBLOBEVENTS_HPP
#define JVMTICODEBLOBEVENTS_HPP
...
// FIXME -- nmethod no longer available.  Use CodeBlob, instead?
// class nmethod;
...
static void build_jvmti_addr_location_map(const CodeBlob*blob,
jvmtiAddrLocationMap**map,
					    jint *map_length);
}; 

#endif
#endif // JVMTICODEBLOBEVENTS_HPP
