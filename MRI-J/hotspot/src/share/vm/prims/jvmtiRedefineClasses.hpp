...
#ifndef JVMTIREDEFINECLASSES_HPP
#define JVMTIREDEFINECLASSES_HPP
...
class VM_RedefineClasses: public VM_Operation {
 friend void jvmtiRedefineClasses_static_init();

 private:
  // These static fields are needed by SystemDictionary::classes_do()
  // facility and the adjust_cpool_cache_and_vtable() helper:
  static objArrayRef     _old_methods;
  static objArrayRef     _new_methods;  
  static methodRef*      _matching_old_methods;
  static methodRef*      _matching_new_methods;  
  static methodRef*      _deleted_methods;
  static methodRef*      _added_methods;  
  static int             _matching_methods_length;  
  static int             _deleted_methods_length;
  static int             _added_methods_length;
  static klassRef        _the_class_oop;
  ...
  static objArrayOop old_methods() { return lvb_objArrayRef(&_old_methods).as_objArrayOop(); }
  static objArrayOop new_methods() { return lvb_objArrayRef(&_new_methods).as_objArrayOop(); }
  static klassOop the_class_oop()  { return lvb_klassRef(&_the_class_oop).as_klassOop(); }
...
#endif // JVMTIREDEFINECLASSES_HPP
