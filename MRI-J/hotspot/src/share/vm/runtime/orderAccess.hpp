...
#ifndef ORDERACCESS_HPP
#define ORDERACCESS_HPP
...
class OrderAccess : AllStatic {
 public:
inline static void loadload();
inline static void storestore();
inline static void loadstore();
inline static void storeload();

inline static void acquire();
inline static void release();
inline static void fence();

inline static jbyte load_acquire(volatile jbyte*p);
inline static jshort load_acquire(volatile jshort*p);
inline static jint load_acquire(volatile jint*p);
inline static jlong load_acquire(volatile jlong*p);
inline static jubyte load_acquire(volatile jubyte*p);
inline static jushort load_acquire(volatile jushort*p);
inline static juint load_acquire(volatile juint*p);
inline static julong load_acquire(volatile julong*p);
inline static jfloat load_acquire(volatile jfloat*p);
inline static jdouble load_acquire(volatile jdouble*p);

inline static intptr_t load_ptr_acquire(volatile intptr_t*p);
inline static void*load_ptr_acquire(volatile void*p);
inline static void*load_ptr_acquire(const volatile void*p);

inline static void release_store(volatile jbyte*p,jbyte v);
inline static void release_store(volatile jshort*p,jshort v);
inline static void release_store(volatile jint*p,jint v);
inline static void release_store(volatile jlong*p,jlong v);
inline static void release_store(volatile jubyte*p,jubyte v);
inline static void release_store(volatile jushort*p,jushort v);
inline static void release_store(volatile juint*p,juint v);
inline static void release_store(volatile julong*p,julong v);
inline static void release_store(volatile jfloat*p,jfloat v);
inline static void release_store(volatile jdouble*p,jdouble v);

inline static void release_store_ptr(volatile intptr_t*p,intptr_t v);
inline static void release_store_ptr(volatile void*p,void*v);

inline static void store_fence(jbyte*p,jbyte v);
inline static void store_fence(jshort*p,jshort v);
inline static void store_fence(jint*p,jint v);
inline static void store_fence(jlong*p,jlong v);
inline static void store_fence(jubyte*p,jubyte v);
inline static void store_fence(jushort*p,jushort v);
inline static void store_fence(juint*p,juint v);
inline static void store_fence(julong*p,julong v);
inline static void store_fence(jfloat*p,jfloat v);
inline static void store_fence(jdouble*p,jdouble v);

inline static void store_ptr_fence(intptr_t*p,intptr_t v);
inline static void store_ptr_fence(void**p,void*v);

inline static void release_store_fence(volatile jbyte*p,jbyte v);
inline static void release_store_fence(volatile jshort*p,jshort v);
inline static void release_store_fence(volatile jint*p,jint v);
inline static void release_store_fence(volatile jlong*p,jlong v);
inline static void release_store_fence(volatile jubyte*p,jubyte v);
inline static void release_store_fence(volatile jushort*p,jushort v);
inline static void release_store_fence(volatile juint*p,juint v);
inline static void release_store_fence(volatile julong*p,julong v);
inline static void release_store_fence(volatile jfloat*p,jfloat v);
inline static void release_store_fence(volatile jdouble*p,jdouble v);

inline static void release_store_ptr_fence(volatile intptr_t*p,intptr_t v);
inline static void release_store_ptr_fence(volatile void*p,void*v);
