...
class Reflection: public AllStatic {
 private:
  ...
  static objArrayHandle get_parameter_types(methodHandle method, int parameter_count, oop* return_type, intptr_t sba_hint, TRAPS);
  static objArrayHandle get_exception_types(methodHandle method, intptr_t sba_hint, TRAPS);
 ...
 public:
  ...
  static BasicType unbox_for_primitive(objectRef boxed_value, jvalue* value, TRAPS);
  static BasicType unbox_for_regular_object(objectRef boxed_value, jvalue* value);
...
static oop new_method(methodHandle method,bool for_constant_pool_access,intptr_t sba_hint,TRAPS);
  // Create a java.lang.reflect.Constructor object based on a method
static oop new_constructor(methodHandle method,intptr_t sba_hint,TRAPS);
  // Create a java.lang.reflect.Field object based on a field descriptor
static oop new_field(fieldDescriptor*fd,intptr_t sba_hint,TRAPS);
...
private:
  ...
  // which are returned as ints. 
  // Throws IllegalArgumentException. (AZUL NOTE - No exception thrown)
...
static oop invoke_constructor(oop method_mirror,objArrayHandle args,intptr_t sba_hint,TRAPS);
