...
#ifndef CONSTANTTAG_HPP
#define CONSTANTTAG_HPP
...
JVM_CONSTANT_UnresolvedClassInError=105,//Error tag due to resolution error
  JVM_CONSTANT_Dependencyref            = 106,  // Tag for internal dependency oop
...
class constantTag VALUE_OBJ_CLASS_SPEC {
 ...
 public:
  ...
  bool is_dependency() const        { return _tag == JVM_CONSTANT_Dependencyref; }
