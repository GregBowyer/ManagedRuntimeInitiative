    ...
    implements java.io.Serializable, Comparable<String>, CharSequence
{
    ...
    public int lastIndexOf(int ch, int fromIndex) {
        ...
        int i = ((fromIndex >= v.length) ? v.length - 1 : fromIndex);
    ...
    public String substring(int beginIndex, int endIndex) {
        ...
        return ((beginIndex == 0) && (endIndex == value.length)) ? this :
            new String(beginIndex, endIndex - beginIndex, value);
    }
    ...
    public String concat(String str) {
        ...
        getChars(0, value.length, buf, 0);
        str.getChars(0, otherLen, buf, value.length);
        return new String(0, value.length + otherLen, buf);
    }
    ...
    public String toLowerCase(Locale locale) {
        ...
        scan: {
            for (firstUpper = 0 ; firstUpper < value.length; ) {
        ...
        int srcChar;
        int srcCount;
        for (int i = firstUpper; i < value.length; i += srcCount) {
            srcChar = (int)value[i];
        ...
        return new String(0, value.length+resultOffset, result);
    }
    ...
    public String toUpperCase(Locale locale) {
        ...
        char[]  result       = new char[value.length]; /* may grow */
        int     resultOffset = 0;  /* result may grow, so i+resultOffset
                                    * is the write location in result */
        ...
        int srcChar;
        int srcCount;
        for (int i = firstLower; i < value.length; i += srcCount) {
            srcChar = (int)value[i];
            if ((char)srcChar >= Character.MIN_HIGH_SURROGATE &&
                (char)srcChar <= Character.MAX_HIGH_SURROGATE) {
                srcChar = codePointAt(i);
