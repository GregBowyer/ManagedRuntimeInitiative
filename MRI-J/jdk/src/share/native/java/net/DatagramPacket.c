...
#ifdef AZPROXIED
    idarray[DATAGRAM_DPBUFFER_FIELDID]    = dp_bufID;
    idarray[DATAGRAM_DPADDRESS_FIELDID]   = dp_addressID;
    idarray[DATAGRAM_DPOFFSET_FIELDID]    = dp_offsetID;
    idarray[DATAGRAM_DPBUFLENGTH_FIELDID] = dp_bufLengthID;
    idarray[DATAGRAM_DPLENGTH_FIELDID]    = dp_lengthID;
    idarray[DATAGRAM_DPPORT_FIELDID]      = dp_portID;
#endif // AZPROXIED
}
