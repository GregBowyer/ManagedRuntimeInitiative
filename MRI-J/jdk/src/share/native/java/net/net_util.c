...
extern jint IPv6_supported(int) ;

static int IPv6_available;

#ifdef AZ_PROXIED
jfieldID idarray[DATAGRAM_NUMBER_OF_FIELDIDS];

JNIEXPORT void JNICALL set_ipv6_available(int _IPv6_available) 
{
    IPv6_available = _IPv6_available;
}
#endif /* AZ_PROXIED */
...
JNI_OnLoad(JavaVM *vm, void *reserved)
{
    ...
    */
    IPv6_available = IPv6_supported(preferIPv4Stack) & (!preferIPv4Stack);
    initLocalAddrTable ();
    return JNI_VERSION_1_2;
}
