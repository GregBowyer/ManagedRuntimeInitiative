...
#else  /* AZ_PROXIED */
/*
 * All methods in this file are still implemented as remote JNI calls
 *
 * void Java_java_net_NetworkInterface_init(JNIEnv *env, jclass cls);
 * jobject Java_java_net_NetworkInterface_getByName0(JNIEnv *env, jclass cls, jstring name);
 * jobject Java_java_net_NetworkInterface_getByIndex(JNIEnv *env, jclass cls, jint index);
 * jobject Java_java_net_NetworkInterface_getByInetAddress0(JNIEnv *env, jclass cls, jobject iaObj);
 * jobjectArray Java_java_net_NetworkInterface_getAll(JNIEnv *env, jclass cls);
 */
...
static short getFlags(JNIEnv *env, jstring name) {
  ...
  return ret;
#else  /* AZ_PROXIED */
  os_unimplemented(/* remote jni call */);
  return -1;
#endif /* AZ_PROXIED */
}
